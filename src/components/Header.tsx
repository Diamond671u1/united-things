      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            {/* These links can be updated to point to actual pages later */}
            <a href="#" onClick={() => handleNavClick('home')} className="text-gray-600 hover:text-brand-blue transition duration-300">About Us</a>
            <a href="#" onClick={() => handleNavClick('home')} className="text-gray-600 hover:text-brand-blue transition duration-300">Contact</a>
          </nav>
      ...
      {isMobileMenuOpen && (
         <div className="fixed inset-0 bg-white z-40 flex flex-col items-center justify-center p-6 md:hidden">
            <nav className="flex flex-col items-center space-y-8 text-2xl">
              ...
              <a href="#" onClick={() => handleNavClick('home')} className="text-brand-text hover:text-brand-blue transition duration-300">About Us</a>
              <a href="#" onClick={() => handleNavClick('home')} className="text-brand-text hover:text-brand-blue transition duration-300">Contact</a>
            </nav>
            {/* Mobile Search */}
